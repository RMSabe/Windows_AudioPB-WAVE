...
AudioPB_i24_2ch::AudioPB_i24_2ch(const audiopb_params_t *p_params) : AudioPB(p_params)
{
}
...
BOOL WINAPI AudioPB_i24_2ch::audio_hw_init(VOID)
{
	...
	{
		this->err_msg = TEXT("AudioPB_i24_2ch::audio_hw_init: Error: p_audiodev is NULL.");
		return FALSE;
	}
	...
	if(n_ret != S_OK)
	{
		...
		this->err_msg = TEXT("AudioPB_i24_2ch::audio_hw_init: Error: IMMDevice::Activate failed.");
		return FALSE;
	}
	...
	wavfmt.Format.nBlockAlign = 8u;
	wavfmt.Format.nSamplesPerSec = (DWORD) this->SAMPLE_RATE;
	wavfmt.Format.nAvgBytesPerSec = ((DWORD) this->SAMPLE_RATE)*8u;
	...
	{
		this->audio_hw_deinit_device();
		this->err_msg = TEXT("AudioPB_i24_2ch::audio_hw_init: Error: audio stream format not supported.");
		return FALSE;
	}
	...
	{
		this->audio_hw_deinit_device();
		this->err_msg = TEXT("AudioPB_i24_2ch::audio_hw_init: Error: IAudioClient::Initialize failed.");
		return FALSE;
	}
	...
	{
		this->audio_hw_deinit_device();
		this->err_msg = TEXT("AudioPB_i24_2ch::audio_hw_init: Error: IAudioClient::GetBufferSize failed.");
		return FALSE;
	}
	...
	{
		this->audio_hw_deinit_device();
		this->err_msg = TEXT("AudioPB_i24_2ch::audio_hw_init: Error: IAudioClient::GetService failed.");
		return FALSE;
	}
...
VOID WINAPI AudioPB_i24_2ch::buffer_load(VOID)
{
	...
	if(n_ret != S_OK) app_exit(1u, TEXT("AudioPB_i24_2ch::buffer_load: Error: IAudioRenderClient::GetBuffer failed."));
